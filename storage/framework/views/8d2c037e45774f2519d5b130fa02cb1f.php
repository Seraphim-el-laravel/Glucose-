...
unset($__errorArgs, $__bag); ?> " name="name"  placeholder="Name"
                        value="<?php echo e(isset($user) ? $user->name : old('name')); ?>">
...
unset($__errorArgs, $__bag); ?>" name="email"  value="<?php echo e(isset($user) ? $user->email : old('email')); ?>" placeholder="Email">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control <?php $__errorArgs = ['re_pass'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="re_pass"  placeholder="Konfirmasi Password">
                        <?php $__errorArgs = ['re_pass'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
</div><?php /**PATH D:\XAMPP DOC\htdocs\SistemPakar\resources\views/admin/user/create.blade.php ENDPATH**/ ?>